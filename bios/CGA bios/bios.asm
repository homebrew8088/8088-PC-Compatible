...
MESSAGE_1:
	...
	.MESSAGE:
	DB 'BIOS 0.1 EMM 19 JUN 21', 0X0D, 0X0A
...
INITIALIZE_70208:
	...
	MOV AL, 0XFF		;0XFF;BITS 7-6 = IO, 5-4 = UPPER MEM, 3-2 = MIDDLE MEM, 1-0 LOWER MEM
